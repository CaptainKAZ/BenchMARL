...
if __name__ == '__main__':
    ...
    model_config = EnsembleModelConfig({"attacker":MlpConfig.get_from_yaml(), "defender":GruConfig.get_from_yaml()}) 
    critic_model_config = EnsembleModelConfig({"attacker":MlpConfig.get_from_yaml(), "defender":GruConfig.get_from_yaml()}) 
